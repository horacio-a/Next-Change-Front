...
const ConversionPage = (props) => {
    ...
    const traerConversion = async () => {
        axios.get(`${process.env.REACT_APP_PAGE}/conver/${desdeValue}/${hastaValue}/${cantidValue}/${process.env.REACT_APP_API_KEY}`).then((response) => {
                ...
                <div className="conteineres-columnas">
                    ...
                    <div className="columna">
                        ...
                        <div className="conteiner-valores">
                            ...
                            <div className="resultado">{ValorConvesion}</div>
                        </div>
